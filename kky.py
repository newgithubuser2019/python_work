...
# ---------------------------------------------------------------------------------------------------------------------------------------------------------------
# file paths
path1 = USERPROFILE + "\\Documents\\Работа\\отчетность\\ежедневно\\накопительный отчет\\оу контрольная карта убой\\"
path2 = USERPROFILE + "\\Documents\\Работа\\отчетность\\ежедневно\\накопительный отчет\\реализация\\"
listoffiles = os.listdir(path1)
listoffiles2 = os.listdir(path2)
# filename0a = USERPROFILE + "\\Documents\\Работа\\отчетность\\ежедневно\\накопительный отчет\\_промежуточный файл findf.xlsx"
...
filename1 = USERPROFILE + "\\Documents\\Работа\\отчетность\\ежедневно\\накопительный отчет\\Динамика развития птицы 2021 Белгород.xlsx"
...
if inp1 == "да" or inp1 == "yes" or inp1 == "y":
    ...
    for i in listoffiles2:
        ...
        print(датасдачи2)
        wb = openpyxl.load_workbook(path2 + i)
        ws = wb["Лист1"]
        rowmax = ws.max_row + 1
        # print(rowmax)
...
#
df_динамика["корп"] = df_динамика["корп"].astype(str)+"_"
df_динамика["корп"] = "_"+df_динамика["корп"]
...
for i in listoffiles:
    ...
    функции.wb_save_openpyxl(wb, path1 + i)
    # exit()
    ...
    #
    df_from_excel["корп"] = df_from_excel["корп"].astype(str)+"_"
    df_from_excel["корп"] = "_"+df_from_excel["корп"]
