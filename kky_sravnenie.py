...
if inp0 == "цб":
        ...
        df_поступление.loc[(df_поступление["ОП"].str.contains("Муромская 2")==True) & (df_поступление["ОП"].str.contains(" РМ")==False), ["ОП"]] = "Муромское 1"
