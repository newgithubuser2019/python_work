...
filename1 = USERPROFILE + "\\Documents\\Работа\\отчетность\\ежедневно\\накопительный отчет\\динамика развития птицы\\Динамика развития птицы Белгород.xlsx"
...
df_pivot = df_pivot.rename(columns={
    ...
    "Головы_Выбраковка сверх нормы": "Выбр с/н голов",
    #
    ...
    "Вес, кг_Выбраковка сверх нормы": "Выбр с/н вес",
    })
try:
...
try:
    ...
    df_pivot["Выбр с/н голов"] = 0
    df_pivot["Выбр с/н вес"] = 0
    df_pivot = df_pivot[[
        "площ",
        "корп",
        "Живок голов",
...
if inp6 == "да" or inp6 == "yes" or inp6 == "y":
    ...
    df_бройлеры = функции.pd_movecol(
        df_бройлеры,
        cols_to_move=["Выбр с/н голов", "Выбр с/н вес"],
        ref_col="Живок вес",
        place="After"
        )
